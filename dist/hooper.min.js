        ...
        methods: {
          ...
          onDragEnd: function() {
            ...
            if (((this.isDragging = !1), this.config.vertical)) {
              ...
              this.slideTo(this.currentSlide - r(this.delta.y) * i);
            }
            if (!this.config.vertical) {
              var e = (this.config.rtl ? -1 : 1) * r(this.delta.x),
        ...
        render: function(t) {
          ...
          return t(
            'li',
            {
              class: i,
              style: this.style,
              attrs: { 'aria-hidden': !this.isActive, tabindex: this.isActive ? void 0 : -1 }
            },
            e
          );
        }
    ...
    var $ = {
      ...
      render: function(t) {
        var i = this,
          ...
          n = [
            y(t, this.isPrevDisabled, this.$slots['hooper-prev'], !0, e, function() {
              return i.slidePrev();
            }),
            y(t, this.isNextDisabled, this.$slots['hooper-next'], !1, e, function() {
              return i.slideNext();
            })
          ];
        return t(
